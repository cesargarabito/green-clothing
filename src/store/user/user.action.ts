...
export type SingInSuccess = ActionWithPayload<USER_ACTION_TYPES.SIGN_IN_SUCCESS, UserData>;
...
export const signInSuccess = withMatcher((user: UserData & { id: string }): SingInSuccess =>
